...
import { EditarMentorProfile } from './mentorsProfileModules/EditarModal'
                    ...
                    <div className="video-container pd-2">
                        <div className="video ratio ratio-16x9">
                            ...
                            <div className="card-body" id="drop-description">
                               ...
                               <EditarMentorProfile mentorprofileInformation = {mentorProfileInformationParameter} setMentorProfile={setMentorProfileFunction}/>{/*modal*/}
