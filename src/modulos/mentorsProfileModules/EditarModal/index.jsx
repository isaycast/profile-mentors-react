...
const EditarMentorProfile = ({mentorprofileInformation, setMentorProfile}) => {{/*mentorprofileInformation puede ser nombrado de diferente forma
                                                                                    porque es un parametro*/}
    ...
    const onSubmitInformation = (event) => {
        event.preventDefault();{/*Es necesario ponerlo para que la pagina no se refresque y se eliminen los datos actulizados*/ }
        setMentorProfile({
          ...
          <div className="modal-dialog modal-dialog-centered">
              <div className="modal-content">
                  <div className="modal-header">
                      ...
                      <button type="button" onClick={onClickUpdate} className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                  </div>
                  <form onSubmit={onSubmitInformation}>
                    <div className="modal-body">
                        <EditarTextContent title = "Sobre mi" 
                                            editInfo = {sobremi}
                                            setEditInfo = {setSobremi} />
                        <EditarTextContent title = "Educacion" 
                                            editInfo = {education}
                                            setEditInfo = {setEducation} />
                        <EditarTextContent title = "Datos curiosos" 
                                            editInfo = {datoCurioso}
                                            setEditInfo = {setDatoCurioso} />
                    </div>
                    <div className="modal-footer">
                        <button type="button"   onClick={onClickUpdate} className="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
